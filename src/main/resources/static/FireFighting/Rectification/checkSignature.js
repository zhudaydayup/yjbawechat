...
var sCode = getUrlParam("sCode");
  ...
  function updateSighRecord(signName,EventId){
      $.ajax({
          type: "POST",
          url:  "../timeRectification/UpdateCheckSignature",
          data: {
          ...
          success: function (data) {
              if (data.backFlag == "ok") {
                  ...
                  window.location.href="../page/procuratorialSignature?RecordId="+EventId+"&social_credit_code="+social_credit_code+"&userId="+userId+"&ID="+ID+"&sCode="+sCode;
