...
function getUrlParam(key){
  ...
  function updateSighRecord(signName,EventId){
      $.ajax({
          type: "POST",
          url:  "../hiddenDanger/UpdateExpertSignature",
          data: {
          ...
          success: function (data) {
              if (data.backFlag == "ok") {
                  ...
                  window.location.href="../exLawDictionary/inspectedUnitSignDanger?RecordId="+EventId+"&userId="+userId+"&social_credit_code="+social_credit_code;
